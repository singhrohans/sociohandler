...
public final class UpdateStatus {
    ...
    public static void main(String[] args) {
        ...
        builder.setOAuthConsumerKey(PostMsg.twitterOuthConsumerKey);
        builder.setOAuthConsumerSecret(PostMsg.twitterOAuthConsumerSecret);
        builder.setOAuthAccessToken(PostMsg.twitterToken);
        builder.setOAuthAccessTokenSecret(PostMsg.twitterOAuthAccessTokenSecret);
